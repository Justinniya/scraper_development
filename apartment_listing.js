...
async function hotel_listing() {
    ...
    let choose_place = await page.locator(`xpath=//*[@id="react-application"]/div/div/div[1]/main/div[2]/div[1]/div/div/div/div/div[2]/div[${choices['House']}]/button`).nth(0);
    await page. waitForTimeout(5000);
    ...
    let place_guest_have = await page.locator(`xpath=//*[@id="react-application"]/div/div/div[1]/main/div[2]/div[1]/div/div/div/div/div[2]/div/div[${place_guest_will['An_entire_place']}]/button`).nth(0);
    await page.waitForTimeout(2000);
    ...
    await page.waitForTimeout(2000);
    const unitLevelValue       = '10A';
    const buildingNameValue    = 'Sunrise Towers';
    const streetAddressValue   = '123 Mango St.';
    const brgyDistrictValue    = 'Lapuz';
    const cityMunicipalityValue= 'Iloilo City';
    const postalCodeValue      = '5000';
    const provinceValue        = 'Iloilo';
    ...
    await number_of_guests(page,8);
    console.log("Number of guests");
    await page.waitForTimeout(500);
    await number_of_bedroom(page,5);
    console.log("number_of_bedroom");
    await page.waitForTimeout(500);
    await number_of_beds(page,5);
    console.log("number_of_beds");
    await page.waitForTimeout(500);
    await number_of_bathrooms(page,true);
